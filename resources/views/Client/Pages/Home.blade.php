...
<body class="w-screen bg-gray-50 overflow-x-hidden" >
    <div id="app" class="w-screen flex flex-col overflow-x-hidden">
        @include('Client.Components.Navigation')

        <main class="w-full text-white pt-[100px] md:pt-[130px] pb-10 px-4 flex flex-col ">
            {{-- HERO SECTION --}}
