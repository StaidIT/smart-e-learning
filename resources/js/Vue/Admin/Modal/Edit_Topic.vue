    ...
    <Transition name="modal-fade">
        ...
        >
            <Transition name="modal-scale" appear>
                <form
                    @submit.prevent="editTopicForm(topicData.id)"
...
async function editTopicForm(id) {
    ...
    try {
        const response = await fetch('/editTopic', {
            method: 'PUT',
            ...
            body: JSON.stringify({
                topic_id : id,
                new_topic_name : props.topicData.topic_name
            })
        });
